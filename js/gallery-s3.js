...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayAlbums(data) {
        ...
        data.albums.forEach(album => {
            ...
            // Use cover photo from S3 (coverPhoto is the file ID)
            const coverImage = album.coverPhoto
                ? `https://s3.pilw.io/kaiugalerii/images/${album.coverPhoto}-thumbnail.jpg`
                : '';

            const fallbackImage = album.coverPhoto
                ? `https://drive.google.com/thumbnail?id=${album.coverPhoto}&sz=w400`
                : '';
